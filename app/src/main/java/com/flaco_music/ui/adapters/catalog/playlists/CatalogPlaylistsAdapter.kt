...
import com.flaco_music.databinding.ItemCatalogPlaylistBinding
...
class CatalogPlaylistsAdapter(
...
) : RecyclerView.Adapter<CatalogPlaylistsAdapter.PlaylistsViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaylistsViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_catalog_playlist, parent, false)
        val binding = ItemCatalogPlaylistBinding.bind(view)
    ...
    inner class PlaylistsViewHolder(private val binding: ItemCatalogPlaylistBinding) :
