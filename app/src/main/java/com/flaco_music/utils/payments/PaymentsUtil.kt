package com.flaco_music.utils.payments

import android.app.Activity
import com.google.android.gms.samples.wallet.PaymentsConstants
...
object PaymentsUtil {
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(PaymentsConstants.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS))
        }
    }
    ...
    private fun directTokenizationSpecification(): JSONObject {
        if (PaymentsConstants.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME" ||
            (PaymentsConstants.DIRECT_TOKENIZATION_PARAMETERS.isEmpty() ||
                    PaymentsConstants.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty())
        ) {
        ...
        return JSONObject().apply {
            put("type", "DIRECT")
            put("parameters", JSONObject(PaymentsConstants.DIRECT_TOKENIZATION_PARAMETERS))
        }
    }
     ...
     */
    private val allowedCardNetworks = JSONArray(PaymentsConstants.SUPPORTED_NETWORKS)
     ...
     * @see [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(PaymentsConstants.SUPPORTED_METHODS)
     ...
     * environment and theme set in [PaymentsConstants].
     *
     * @param activity is the caller's activity.
     */
    fun createPaymentsClient(activity: Activity): PaymentsClient {
        val walletOptions = Wallet.WalletOptions.Builder()
            .setEnvironment(PaymentsConstants.PAYMENTS_ENVIRONMENT)
            .build()
    ...
    private fun getTransactionInfo(price: String): JSONObject {
        return JSONObject().apply {
            ...
            put("countryCode", PaymentsConstants.COUNTRY_CODE)
            put("currencyCode", PaymentsConstants.CURRENCY_CODE)
        }
    }
        ...
        try {
            return JSONObject(baseRequest.toString()).apply {
                ...
                val shippingAddressParameters = JSONObject().apply {
                    ...
                    put("allowedCountryCodes", JSONArray(PaymentsConstants.SHIPPING_SUPPORTED_COUNTRIES))
                }
